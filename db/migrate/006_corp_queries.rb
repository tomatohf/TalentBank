class CorpQueries < ActiveRecord::Migration
  def self.up
    ...
    add_index :corp_query_marks, :corporation_id
    # reserve first 10000 ID
    ActiveRecord::Base.connection.execute("INSERT INTO corp_query_marks (id) VALUES (10000)")
    ActiveRecord::Base.connection.execute("DELETE FROM corp_query_marks WHERE id = 10000")

  end

  def self.down
    
    drop_table :corp_query_marks
