class InternProfile < ActiveRecord::Base
  ...
  validates_length_of :birthplace, :maximum => 25, :message => "户口 超过长度限制", :allow_nil => true
  ...
  validates_length_of :experience, :maximum => 2000, :message => "以往工作/实习经历 超过长度限制", :allow_nil => true
